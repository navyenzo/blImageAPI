#ifndef BL_SERIALIZE_HPP
#define BL_SERIALIZE_HPP


//-------------------------------------------------------------------
// FILE:            blSerialize.hpp
// CLASS:           None
// BASE CLASS:      None
//
...
//-------------------------------------------------------------------
inline std::string DetermineTypeOfImage(const IplImage* SrcImage)
{
...
// DEPENDENCIES:        IplImage
//-------------------------------------------------------------------
inline void DetermineDepthAndNumOfChannels(const std::string& TypeOfImage,
                                           int& Depth,
                                           int& NumOfChannels)
{
                                    ...
                                    const std::string& ImageTag)
{
    ...
    //              depth
    std::string TypeOfImage = DetermineTypeOfImage(SrcImage);
                                     ...
                                     const std::string& ImageTag)
{
    ...
    std::string TypeOfImage = cvReadString(CurrentFileNode,"u");
